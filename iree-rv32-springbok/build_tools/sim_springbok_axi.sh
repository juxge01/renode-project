...
#RENODE_PATH=./build/renode/renode
RENODE_PATH=/home/jueun/park/renode/renode/renode

bin_file=$(realpath $1)
(cd "${ROOTDIR}" && ${RENODE_PATH} -e "\$bin=@${bin_file}; i @sim/config/springbok_axi_pim_test.resc; \
