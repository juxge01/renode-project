...
VL_ATTR_COLD void Vaxi_sa_16x16_group_processing_element_128___ctor_var_reset(Vaxi_sa_16x16_group_processing_element_128* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vaxi_sa_16x16__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+            Vaxi_sa_16x16_group_processing_element_128___ctor_var_reset\n"); );
    // Body
