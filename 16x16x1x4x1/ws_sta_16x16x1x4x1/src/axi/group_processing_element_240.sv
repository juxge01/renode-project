...
module group_processing_element_240(
  input         clock,
                reset,
  ...
  processing_element_960 vectorProcessingElementVector_0_0 (
    .clock         (clock),
    .reset         (reset),
  ...
  processing_element_960 vectorProcessingElementVector_0_1 (
    .clock         (clock),
    .reset         (reset),
    .io_inputA_0   (io_inputA_0),
  ...
  processing_element_960 vectorProcessingElementVector_0_2 (
    .clock         (clock),
    .reset         (reset),
    .io_inputA_0   (io_inputA_0),
  ...
  processing_element_960 vectorProcessingElementVector_0_3 (
    .clock         (clock),
    .reset         (reset),
    .io_inputA_0   (io_inputA_0),
