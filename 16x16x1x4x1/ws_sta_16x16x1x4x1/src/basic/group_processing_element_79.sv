...
module group_processing_element_79(
  input         clock,
                reset,
  ...
  wire [18:0] _vectorProcessingElementVector_0_3_io_outputC;
  wire [18:0] _vectorProcessingElementVector_0_2_io_outputC;
  wire [18:0] _vectorProcessingElementVector_0_1_io_outputC;
  wire [18:0] _vectorProcessingElementVector_0_0_io_outputC;
  reg  [18:0] io_outputC_0_REG;
  reg  [18:0] io_outputC_1_REG;
  reg  [18:0] io_outputC_2_REG;
  reg  [18:0] io_outputC_3_REG;
  always @(posedge clock) begin
    if (reset) begin
      io_outputC_0_REG <= 19'h0;
      io_outputC_1_REG <= 19'h0;
      io_outputC_2_REG <= 19'h0;
      io_outputC_3_REG <= 19'h0;
    end
    else begin
  ...
  processing_element_256 vectorProcessingElementVector_0_0 (
    .clock         (clock),
    .reset         (reset),
  ...
  processing_element_256 vectorProcessingElementVector_0_1 (
    .clock         (clock),
    .reset         (reset),
    .io_inputA_0   (io_inputA_0),
  ...
  processing_element_256 vectorProcessingElementVector_0_2 (
    .clock         (clock),
    .reset         (reset),
    .io_inputA_0   (io_inputA_0),
  ...
  processing_element_256 vectorProcessingElementVector_0_3 (
    .clock         (clock),
    .reset         (reset),
    .io_inputA_0   (io_inputA_0),
