...
#ifndef VERILATED_VAXI_PIM_H_
#define VERILATED_VAXI_PIM_H_  // guard

#include "verilated.h"

class Vaxi_pim__Syms;
class Vaxi_pim___024root;

// This class is the main interface to the Verilated model
class Vaxi_pim VL_NOT_FINAL : public VerilatedModel {
  private:
  ...
  public:
    ...
    Vaxi_pim___024root* const rootp;
    ...
    explicit Vaxi_pim(VerilatedContext* contextp, const char* name = "TOP");
    explicit Vaxi_pim(const char* name = "TOP");
    /// Destroy the model; called (often implicitly) by application code
    virtual ~Vaxi_pim();
  private:
    VL_UNCOPYABLE(Vaxi_pim);  ///< Copying not allowed
