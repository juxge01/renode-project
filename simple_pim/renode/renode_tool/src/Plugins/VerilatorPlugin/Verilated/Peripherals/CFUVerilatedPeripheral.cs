...
namespace Antmicro.Renode.Peripherals.Verilated
{
    public class CFUVerilatedPeripheral : ICFU, IDisposable, IHasOwnLife
    {
        ...
        private void RegisterCFU()
        {
            ...
            string opcodePattern = "-------------------------1111011"; // Custom-3 pattern
            /*
            ...
            */
            ...
            connectedCpu.InstallCustomInstruction(pattern: opcodePattern, handler: HandleCustomInstruction);
            this.Log(LogLevel.Noisy, "Custom CFU instruction registered");
            
            // TODO: ==================================================================================
            // connectedCpu.InstallCustomInstruction(pattern: "-------------------------1111011", handler: HandleCFUCustom3);
        ...
        //     this.Log(LogLevel.Info, "Greeting! this is HandleCFUCustom3, funct3={0}", funct3);
        //     UInt64 result = 0UL;
        ...
        private void HandleCustomInstruction(ulong opcode)
        {
            ...
            {
                case 0:
                    SetCFUMacOutValue(rs1Value);
                    this.Log(LogLevel.Info, $"[CFU] Setting macOutValue to {rs1Value}");
                    break;

                case 1:
                    var macOut = GetCFUMacOutValue();
                    connectedCpu.SetRegisterUnsafe(rD, macOut); 
                    this.Log(LogLevel.Info, $"[CFU] macOutValue retrieved: {macOut}");
                    break;

                default:
                    this.Log(LogLevel.Error, " CFU instruction funct3: {0} (opcode: 0x{1:X})", funct3, opcode);
                    break;Unhandled
            }
            // ========================================================================================
        }
        ...
        // TODO: ==================================================================================
        public void HelloCFU() {
            this.Log(LogLevel.Info, "HelloCFU World!");
        }
        // ========================================================================================
