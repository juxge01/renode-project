...
#ifndef VERILATED_VAXI_SA_16X16_GROUP_PROCESSING_ELEMENT_32_H_
#define VERILATED_VAXI_SA_16X16_GROUP_PROCESSING_ELEMENT_32_H_  // guard

#include "verilated.h"

class Vaxi_sa_16x16__Syms;

class Vaxi_sa_16x16_group_processing_element_32 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vaxi_sa_16x16_group_processing_element_32(Vaxi_sa_16x16__Syms* symsp, const char* name);
    ~Vaxi_sa_16x16_group_processing_element_32();
    VL_UNCOPYABLE(Vaxi_sa_16x16_group_processing_element_32);
