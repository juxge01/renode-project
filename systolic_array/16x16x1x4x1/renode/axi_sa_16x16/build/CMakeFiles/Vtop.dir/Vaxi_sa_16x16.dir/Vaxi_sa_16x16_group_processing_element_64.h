...
#ifndef VERILATED_VAXI_SA_16X16_GROUP_PROCESSING_ELEMENT_64_H_
#define VERILATED_VAXI_SA_16X16_GROUP_PROCESSING_ELEMENT_64_H_  // guard

#include "verilated.h"

class Vaxi_sa_16x16__Syms;

class Vaxi_sa_16x16_group_processing_element_64 final : public VerilatedModule {
  public:
    ...
    // CONSTRUCTORS
    Vaxi_sa_16x16_group_processing_element_64(Vaxi_sa_16x16__Syms* symsp, const char* name);
    ~Vaxi_sa_16x16_group_processing_element_64();
    VL_UNCOPYABLE(Vaxi_sa_16x16_group_processing_element_64);
