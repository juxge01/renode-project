...
RenodeAgent *axi_sa_32x32;
Vaxi_sa_32x32 *top = new Vaxi_sa_32x32;
VerilatedVcdC *tfp;
...
RenodeAgent *Init() {
    ...
    // Init peripheral
    //=================================================
    axi_sa_32x32 = new RenodeAgent(bus);
    bus->setAgent(axi_sa_32x32);
    return axi_sa_32x32;
}
...
#endif
    Init();
    axi_sa_32x32->simulate(atoi(argv[1]), atoi(argv[2]), address);
    top->final();
    exit(0);
}
