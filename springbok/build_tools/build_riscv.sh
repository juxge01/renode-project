...
ROOT_DIR="/home/jueun/park/IREE/iree-rv32-springbok-legacy"

CMAKE_BIN="${CMAKE_BIN:-$(which cmake)}"
#RISCV_RV32_NEWLIB_TOOLCHAIN_ROOT="${RISCV_RV32_NEWLIB_TOOLCHAIN_ROOT:-$ROOT_DIR/build/toolchain_iree_rv32imf}"
# RISCV_RV32_NEWLIB_TOOLCHAIN_ROOT="/home/euntae/build/riscv/rv32imf-llvm"
RISCV_RV32_NEWLIB_TOOLCHAIN_ROOT="/home/jueun/park/build/riscv/rv32imf-llvm"

"${CMAKE_BIN?}" --version
ninja --version

# IREE_SOURCE="${IREE_SOURCE:-$ROOT_DIR/third_party/iree}"
IREE_SOURCE="/home/jueun/park/IREE/iree-rv32-springbok-legacy/third_party/iree"
...
# BUILD_HOST_DIR="/home/euntae/build/iree-compiler/iree-build-candidate-20240109.765/install"
BUILD_HOST_DIR="/home/jueun/park/IREE/iree-dist-20230218.434-linux-x86_64"
...
# echo "cmake --build ${BUILD_RISCV_DIR}"
